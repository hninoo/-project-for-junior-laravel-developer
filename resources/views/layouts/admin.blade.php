...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('template/css/model.css') }}">
</head>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item dropdown d-none d-xl-inline-block">
            <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <span class="profile-text">Hello,Mrs.Admin!</span>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                ...
                <div class="text-wrapper">
                  <p class="profile-name">Mrs.Admin</p>
                  <div>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href="{{url('unassigned_user')}}">Assign</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="{{url('unactive_user')}}">Unactive</a>
                </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{url('leave_review')}}">
