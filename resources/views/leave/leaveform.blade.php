...
{!! Form :: open(array('url'=>'leave/'.$leave_res['account_id'],'class'=>'printPreview','id'=>'toPrint'))!!}
<input type="hidden" name="status_id" value="{{$leave_res['status_id']}}">
<div class="container">
        ...
        <table class="table table-bordered">
              <thead>
                ...
                <tbody>
                  ...
                  <input type="hidden" name="hide_check_id" value="{{$leave_res['check_id']}}">
